...
<h3>INPUT DATA</h3>
<hr>
<form action="prosesinputpengarang_1.jsp" method="post">
<table width="500px" border="5">
<tr>
<td width="120px">Kode Pengarang</td><td><input type="text"name="kodePengarang"></td>
</tr>
<td width="120px">Pengarang</td><td><input type="text"name="pengarang"></td>
</tr>
<tr>
